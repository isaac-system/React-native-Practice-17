...
import {View, Text, Image, FlatList, StyleSheet, Share} from 'react-native';
import Animated, {
  Extrapolate,
  interpolate,
...
const CourseListening = ({navigation, route}) => {
  ...
  function renderHeader() {
    ...
    const haederOnScrollAnimatedStyle = useAnimatedStyle(() => {
      return {
...
CourseListening.sharedElements = (route, otherRoute, showing) => {
